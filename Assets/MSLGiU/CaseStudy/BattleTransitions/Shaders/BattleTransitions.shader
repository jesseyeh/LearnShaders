Shader "MSLGiU/CaseStudy/BattleTransitions"
{
	Properties
	{
	...
	SubShader
	{
      ...
      v2f simplevert(appdata v)
      {
        ...
        // two sets of uv coordinates, one to sample from the main texture and another for other textures
        // the second set will be flipped depending on the platform and MSAA settings
        o.uv = v.uv;
