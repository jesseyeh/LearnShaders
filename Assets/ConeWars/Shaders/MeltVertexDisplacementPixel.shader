Shader "ConeWars/MeltVertexDisplacementPixel" {
    Properties {
...
;
        ...
        void surf (Input IN, inout SurfaceOutputStandard o) {
            ...
            o.Albedo = lerp(c.rgb, _MeltColor.rgb, IN.pixelMelt);
            // Metallic and smoothness come from slider variables
            o.Metallic = lerp(_Metallic, _MeltMetallic, IN.pixelMelt);
            o.Smoothness = lerp(_Glossiness, _MeltGlossiness, IN.pixelMelt);
            o.Alpha = c.a;
        }
        ENDCG
    }
